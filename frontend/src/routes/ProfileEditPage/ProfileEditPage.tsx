import { Button, Chip, FormControl, FormControlLabel, FormLabel, InputAdornment, Radio, RadioGroup, Stack, TextField, Typography } from '@mui/material';
...
export default function ProfileEditPage(): JSX.Element {
  ...
  return (unsavedProfile ?
    <Stack sx={{ margin: '1em' }} direction="column" spacing={2}>
